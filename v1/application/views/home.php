...
<main>
   ...
   <section class="tp-company-6-area fix p-relative parallax-item pt-90 pb-50" style="background-color: #fff;" id="about">
      <div class="container">
         <div class="row">
   ...
   <section class="tp-project-area tp-project-bottom-color p-relative parallax-item" style="background-color: #fff" id="service">

      <div class="row">
         <div class="col-lg-6 col-md-6 grid-item cat2 cat4 cat5">
         ...
         <div class="col-lg-6 col-md-6 grid-item cat2 cat4 cat5 othr-box">
            ...
            <div class="tp-project-item p-relative fix">
               <div class="tp-project-thumb p-relative fix">
                  ...
                  <h2 class="othr-abt-hdg1">Hydraulic Drill Rig</h2>
                  <p class="othr-abt-pr">IMT, a global leader in the manufacture of drill rigs <br>
                     and a brand which has always been synonymous <br>
                     with quality and reliability in the pursuit of satisfying <br>
                     market demand, is pleased to present a new <br>
                     series of A drill rigs. This new line is unique in its <br>
                     simplicity and flexibility of use, while also perfectly <br>
                     maintaining sturdiness and productivity. <br>
                     The A90 drill rig is suitable for the use in several
                     .</p>
               </div>
               <a class="tp-btn tp-icon-style pink about-btn" href="<?= base_url() ?>#contact">Reach Us<span>
                     <img src="<?= base_url() ?>assets/img/icons/Vector Smart Object.png" alt="power base" class="our-btn">
         ...
         <div class="col-lg-6 col-md-6 grid-item cat2 cat4 cat5 d-md-none">
            <div class="tp-project-item p-relative fix">
               <div class="tp-project-thumb p-relative fix">
                  <a href="<?= base_url() ?>l">
         ...
         <div class="col-lg-6 col-md-6 grid-item cat2 cat4 cat5 other-d-none">
            <div class="tp-project-item p-relative fix">
               <div class="tp-project-thumb p-relative fix">
                  <a href="<?= base_url() ?>">
                     <img src="<?= base_url() ?>assets/img/icons/lyr3-image.jpg" alt="power base">
         ...
         <div class="col-lg-6 col-md-6 grid-item cat2 cat4 cat5 othr-box">
            ...
            <div class="tp-project-item p-relative fix">
               <div class="tp-project-thumb p-relative fix">
                  ...
                  <h2 class="othr-abt-hdg1">Hydraulic Drill Rig</h2>
                  <p class="othr-abt-pr">our expertise spans a wide range of deep foundation <br>
                     techniques, Our dedicated team of professionals <br>
                     possesses extensive experience and technical <br>
                     proficiency, ensuring the highest standards of quality <br>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 text-center">
               <div class="tp-contact-title-wrapper p-relative wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">
   ...
   <!-- contact area start -->
   <section class="tp-contact-6-area p-relative pt-46 parallax-item">
                     ...
                     <div class="row">
                        ...
                        <!-- <div class="col-lg-3 col-md-6">
                              <div class="tp-contact-6-btn">
                                 <button class="tp-btn w-100 othr-btn">Submit Now <span><i class="fa-regular fa-arrow-up-right"></i></span></button>
                              </div>
                           </div> -->
                     </div>
