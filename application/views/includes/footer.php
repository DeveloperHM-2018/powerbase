            ...
            <div class="tp-footer-main tp-footer-border">
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12 text-center">
                        <div class="tp-footer-widget tp-footer-6-col-2 mb-15">
                            <p class="tp-footer-widget-title">CONNECT WITH US</p>
                            <p class="mb-2"><a href="mailto:info@powerbasellc.com" class="othr-ftr" target="_blank"><i class="fa fa-envelope contact-icon"></i> info@powerbasellc.com</a></p>
                            <p><a href="tel:+966560266662" class="othr-ftr-2" target="_blank"><i class="fas fa-phone contact-icon"></i> +966 560266662</a> |
                                <a href="tel:+966552275554" class="othr-ftr-2" target="_blank">+966 552275554</a>
                            </p>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12 text-center">
                        <div class="tp-footer-widget tp-footer-6-col-3">
                            <div class="tp-footer-widget-content ftr-icon">
                                <div class="tp-footer-widget-social">
                                    <a href="<?= base_url() ?>"><i class="fab fa-facebook-f"></i></a>
                                    <a href="<?= base_url() ?>"><i class="fa-brands fa-instagram"></i></a>
                                    <!-- <a href="<?= base_url() ?>"><i class="fa-brands fa-whatsapp"></i></a> -->
                                </div>
                            </div>
                        </div>
                    </div>
